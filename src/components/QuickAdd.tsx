...
const priorityLevels = [
  ...
  { value: "Med", label: "Medium", color: "bg-yellow-100 text-yellow-800" },
    ...
    <Card className="p-4 bg-card border-2 border-primary shadow-glow">
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <Input
          ...
          placeholder={`Draft client deck #${
            projectNames.length > 0 ? projectNames[0].toLowerCase() : "project"
          } @goal ^L`}
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setSelectedPriority(value as "Low" | "Med" | "High")
            }
            disabled={isSubmitting}
          >
            <SelectTrigger className="w-full bg-background border-border">
        ...
        <div className="flex gap-2">
          <Button
            ...
            disabled={isSubmitting || !taskText.trim() || !selectedProjectName}
          >
            {isSubmitting ? "Adding..." : "Add task"}
          </Button>
          <Button
